...
var ODD_DAYS = {
  ...
  1: new Set([6,7,8,9,10,11,12,20,21,22,23,24,25,26]),
  2: new Set([6,7,8,9,10,11,12,20,21,22,23,24,25,26]),
  3: new Set([3,4,5,6,7,8,9,17,18,19,20,21,22,23]),
  4: new Set([1,2,3,4,5,6,7,15,16,17,18,19,20,21,29,30,31]),
  5: new Set([1,2,3,4,12,13,14,15,16,17,18,26,27,28,29,30]),
  6: new Set([1,2,10,11,12,13,14,15,16,24,25,26,27,28,29,30]),
  7: new Set([7,8,9,10,11,12,13,21,22,23,24,25,26,27]),
  8: new Set([4,5,6,7,8,9,10,18,19,20,21,22,23]),
  9: new Set([2,3,4,5,6,7,8,16,17,18,19,20,21,22]),
}
